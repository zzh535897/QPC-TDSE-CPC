...
static constexpr size_t n_core		=	40ul;	//number of logical processors to be used

//parameters of spatial configuration
static constexpr size_t n_ndim		=	400ul;
static constexpr size_t n_ldim		=	18ul;
static constexpr size_t n_mdim		=	150ul;
static constexpr long	n_mmin		=	-11;

static constexpr size_t n_rank		=	8ul;	//do not change unless you know what may happen

static constexpr double	para_rmin	=	0.0;
static constexpr double	para_rmax	=	200.;	//to hold all, you will need about 1000.
...
};//model potential for helium atom
...
static constexpr double spec_krmin	=	0.7;
static constexpr double spec_krmax	=	2.3;
...
static constexpr size_t spec_nkr	=	512ul;
...
static constexpr double tsurff_r0	=	120.0;
...
using	envelope_type	=	qpc::field_component_sinen<4>;//
...
static constexpr double mask_rmin	=	para_rmax-70.;
