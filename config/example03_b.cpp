...
static constexpr int   	to_save_field 		=       1;

static constexpr int	calculate_init		=	0;	//0 = by load, 1 = by exact diagonalization
static constexpr int	calculate_prop		=	1;	//0 = disable, 1 = enable

static constexpr int	calculate_coef		=	1;	//0 = do not save, 1 = do save
static constexpr int   	calculate_disp    	=       1;	//0 = disable, 1 = enable
...
static constexpr int  	use_mask_function	=       1;

//parameters of omp parallelization
static constexpr size_t n_core		=	10ul;

//parameters of spatial configuration
static constexpr size_t n_ndim		=	320ul;
static constexpr size_t n_ldim		=	40ul;
static constexpr size_t n_mdim		=	3ul;
static constexpr long	n_mmin		=	-1;

static constexpr size_t n_rank		=	8ul;	//do not change unless you know what may happen

static constexpr double	para_rmin	=	0.0;
static constexpr double	para_rmax	=	160.;

static constexpr size_t n_pole		=	1ul;	//number of oce poles
static constexpr auto	n_knot		=	std::array<size_t,n_pole>{2};

static constexpr bool	propflag_eve	=	true;
static constexpr bool	propflag_odd	=	true;
//parameters of model potential (centrifugal part)
static constexpr double para_zc		=	0.0;
static constexpr auto	potn		=	spherical::hydrogenic{para_zc};//Zc
...
static constexpr double spec_krmin	=	0.8;
static constexpr double spec_krmax	=	2.1;
...
static constexpr size_t spec_nkr	=	200ul;
static constexpr size_t spec_nkt	=	181ul;
static constexpr size_t spec_nkp	=	361ul;
...
static constexpr double tsurff_r0	=	40.0;
...
static constexpr double para_dt		=	0.02;
static constexpr double para_td		=	25.0;
...
static constexpr double mask_fact	=	1./8.*para_dt;
