...
static constexpr int   	calculate_spec        	=       3;	//0 = disable, 1 = only PM(E)D, 2= only PWM(E)D, 3= both
...
static constexpr auto	potn		=	spherical::hydrogenic{para_zc};//need charge number
