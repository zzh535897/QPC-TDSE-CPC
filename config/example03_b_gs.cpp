...
static constexpr int   	to_save_field 		=       0;
...
static constexpr int  	use_mask_function	=       0;
...
static constexpr double tsurff_r0	=	80.0;
...
static constexpr double mask_rmin	=	para_rmax-1.0;
